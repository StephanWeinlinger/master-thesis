...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a54259 = param;
            StringBuilder b54259 = new StringBuilder(a54259);
            b54259.append(" SafeStuff");
            b54259.replace(
                    b54259.length() - "Chars".length(),
                    b54259.length(),
                    "Chars");
            java.util.HashMap<String, Object> map54259 = new java.util.HashMap<String, Object>();
            map54259.put("key54259", b54259.toString());
            String c54259 = (String) map54259.get("key54259");
            String d54259 = c54259.substring(0, c54259.length() - 1);
            String e54259 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d54259.getBytes())));
            String f54259 = e54259.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g54259 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g54259);
