...
public class SampleValue extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        javax.servlet.RequestDispatcher rd =
                request.getRequestDispatcher("/sample/SampleValue.html");
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map37053.put("keyA-37053", "a_Value");
            map37053.put("keyB-37053", param);
            map37053.put("keyC", "another_Value");
            bar = (String) map37053.get("keyB-37053");
            bar = (String) map37053.get("keyA-37053");
