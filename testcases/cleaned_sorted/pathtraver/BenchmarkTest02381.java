...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map75774.put("keyA-75774", "a_Value");
        map75774.put("keyB-75774", param);
        map75774.put("keyC", "another_Value");
        bar = (String) map75774.get("keyB-75774");
        bar = (String) map75774.get("keyA-75774");
