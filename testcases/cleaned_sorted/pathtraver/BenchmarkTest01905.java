...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map33587.put("keyA-33587", "a_Value");
        map33587.put("keyB-33587", param);
        map33587.put("keyC", "another_Value");
        bar = (String) map33587.get("keyB-33587");
        bar = (String) map33587.get("keyA-33587");
