...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a37769 = param;
            StringBuilder b37769 = new StringBuilder(a37769);
            b37769.append(" SafeStuff");
            b37769.replace(
                    b37769.length() - "Chars".length(),
                    b37769.length(),
                    "Chars");
            java.util.HashMap<String, Object> map37769 = new java.util.HashMap<String, Object>();
            map37769.put("key37769", b37769.toString());
            String c37769 = (String) map37769.get("key37769");
            String d37769 = c37769.substring(0, c37769.length() - 1);
            String e37769 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d37769.getBytes())));
            String f37769 = e37769.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g37769 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g37769);
