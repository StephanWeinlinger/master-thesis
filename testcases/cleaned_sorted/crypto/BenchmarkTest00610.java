...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a51289 = param;
        StringBuilder b51289 = new StringBuilder(a51289);
        b51289.append(" SafeStuff");
        b51289.replace(
                b51289.length() - "Chars".length(),
                b51289.length(),
                "Chars");
        java.util.HashMap<String, Object> map51289 = new java.util.HashMap<String, Object>();
        map51289.put("key51289", b51289.toString());
        String c51289 = (String) map51289.get("key51289");
        String d51289 = c51289.substring(0, c51289.length() - 1);
        String e51289 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d51289.getBytes())));
        String f51289 = e51289.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g51289 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g51289);
