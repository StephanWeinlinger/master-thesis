...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a8142 = param;
        StringBuilder b8142 = new StringBuilder(a8142);
        b8142.append(" SafeStuff");
        b8142.replace(
                b8142.length() - "Chars".length(),
                b8142.length(),
                "Chars");
        java.util.HashMap<String, Object> map8142 = new java.util.HashMap<String, Object>();
        map8142.put("key8142", b8142.toString());
        String c8142 = (String) map8142.get("key8142");
        String d8142 = c8142.substring(0, c8142.length() - 1);
        String e8142 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d8142.getBytes())));
        String f8142 = e8142.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f8142);
