...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a61263 = param;
            StringBuilder b61263 = new StringBuilder(a61263);
            b61263.append(" SafeStuff");
            b61263.replace(
                    b61263.length() - "Chars".length(),
                    b61263.length(),
                    "Chars");
            java.util.HashMap<String, Object> map61263 = new java.util.HashMap<String, Object>();
            map61263.put("key61263", b61263.toString());
            String c61263 = (String) map61263.get("key61263");
            String d61263 = c61263.substring(0, c61263.length() - 1);
            String e61263 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d61263.getBytes())));
            String f61263 = e61263.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String bar = thing.doSomething(f61263);
