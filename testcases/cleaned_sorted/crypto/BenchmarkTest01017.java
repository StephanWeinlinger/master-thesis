...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a27056 = param;
            StringBuilder b27056 = new StringBuilder(a27056);
            b27056.append(" SafeStuff");
            b27056.replace(
                    b27056.length() - "Chars".length(),
                    b27056.length(),
                    "Chars");
            java.util.HashMap<String, Object> map27056 = new java.util.HashMap<String, Object>();
            map27056.put("key27056", b27056.toString());
            String c27056 = (String) map27056.get("key27056");
            String d27056 = c27056.substring(0, c27056.length() - 1);
            String e27056 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d27056.getBytes())));
            String f27056 = e27056.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g27056 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g27056);
