...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        map8361.put("keyA-8361", "a_Value");
        map8361.put("keyB-8361", param);
        map8361.put("keyC", "another_Value");
        bar = (String) map8361.get("keyB-8361");
        bar = (String) map8361.get("keyA-8361");
