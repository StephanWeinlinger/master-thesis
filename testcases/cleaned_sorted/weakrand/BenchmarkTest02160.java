...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map25458.put("keyA-25458", "a_Value");
        map25458.put("keyB-25458", param);
        map25458.put("keyC", "another_Value");
        bar = (String) map25458.get("keyB-25458");
        bar = (String) map25458.get("keyA-25458");
