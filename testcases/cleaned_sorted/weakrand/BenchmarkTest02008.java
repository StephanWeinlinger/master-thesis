...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a97712 = param;
        StringBuilder b97712 = new StringBuilder(a97712);
        b97712.append(" SafeStuff");
        b97712.replace(
                b97712.length() - "Chars".length(),
                b97712.length(),
                "Chars");
        java.util.HashMap<String, Object> map97712 = new java.util.HashMap<String, Object>();
        map97712.put("key97712", b97712.toString());
        String c97712 = (String) map97712.get("key97712");
        String d97712 = c97712.substring(0, c97712.length() - 1);
        String e97712 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d97712.getBytes())));
        String f97712 = e97712.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g97712 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g97712);
