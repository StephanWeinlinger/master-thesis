...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a43050 = param;
            StringBuilder b43050 = new StringBuilder(a43050);
            ...
            map43050.put("key43050", b43050.toString());
            String c43050 = (String) map43050.get("key43050");
            String d43050 = c43050.substring(0, c43050.length() - 1);
            String e43050 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d43050.getBytes())));
            String f43050 = e43050.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g43050 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g43050);
