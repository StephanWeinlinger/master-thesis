...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter()
                .println("Sample Test java.security.SecureRandom.nextFloat() executed");
    }
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a22205 = param;
            StringBuilder b22205 = new StringBuilder(a22205);
            b22205.append(" SafeStuff");
            b22205.replace(
                    b22205.length() - "Chars".length(),
                    b22205.length(),
                    "Chars");
            java.util.HashMap<String, Object> map22205 = new java.util.HashMap<String, Object>();
            map22205.put("key22205", b22205.toString());
            String c22205 = (String) map22205.get("key22205");
            String d22205 = c22205.substring(0, c22205.length() - 1);
            String e22205 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d22205.getBytes())));
            String f22205 = e22205.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g22205 = "barbarians_at_the_gate";
