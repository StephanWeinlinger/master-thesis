...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Problem executing SecureRandom.nextFloat() - Sample");
            throw new ServletException(e);
        }
        response.getWriter()
                .println("Sample Randomness Test java.security.SecureRandom.nextFloat() executed");
    }
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map14411.put("keyA-14411", "a-Value");
        map14411.put("keyB-14411", param);
        map14411.put("keyC", "another-Value");
