...
public class SampleValue extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        javax.servlet.http.Cookie userCookie =
                new javax.servlet.http.Cookie("SampleValue", "does_not_matter");
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map73877.put("keyA-73877", "a_Value");
            map73877.put("keyB-73877", param);
            map73877.put("keyC", "another_Value");
            bar = (String) map73877.get("keyB-73877");
            bar = (String) map73877.get("keyA-73877");
