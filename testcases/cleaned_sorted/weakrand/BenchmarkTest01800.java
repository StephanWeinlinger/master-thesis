...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a71684 = param;
            StringBuilder b71684 = new StringBuilder(a71684);
            b71684.append(" SafeStuff");
            b71684.replace(
                    b71684.length() - "Chars".length(),
                    b71684.length(),
                    "Chars");
            java.util.HashMap<String, Object> map71684 = new java.util.HashMap<String, Object>();
            map71684.put("key71684", b71684.toString());
            String c71684 = (String) map71684.get("key71684");
            String d71684 = c71684.substring(0, c71684.length() - 1);
            String e71684 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d71684.getBytes())));
            String f71684 = e71684.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String bar = thing.doSomething(f71684);
