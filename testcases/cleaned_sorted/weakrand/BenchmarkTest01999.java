...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String rememberMeKey = org.test.samplelib.SAMPLEFUNC.encoder().encodeForBase64(bytes, true);
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map28743.put("keyA-28743", "a-Value");
        map28743.put("keyB-28743", param);
        map28743.put("keyC", "another-Value");
        bar = (String) map28743.get("keyB-28743");
