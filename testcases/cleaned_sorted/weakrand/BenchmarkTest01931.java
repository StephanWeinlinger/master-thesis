...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a40465 = param;
        StringBuilder b40465 = new StringBuilder(a40465);
        b40465.append(" SafeStuff");
        b40465.replace(
                b40465.length() - "Chars".length(),
                b40465.length(),
                "Chars");
        java.util.HashMap<String, Object> map40465 = new java.util.HashMap<String, Object>();
        map40465.put("key40465", b40465.toString());
        String c40465 = (String) map40465.get("key40465");
        String d40465 = c40465.substring(0, c40465.length() - 1);
        String e40465 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d40465.getBytes())));
        String f40465 = e40465.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f40465);
