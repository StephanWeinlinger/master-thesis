...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a5528 = param;
        StringBuilder b5528 = new StringBuilder(a5528);
        b5528.append(" SafeStuff");
        b5528.replace(
                b5528.length() - "Chars".length(),
                b5528.length(),
                "Chars");
        java.util.HashMap<String, Object> map5528 = new java.util.HashMap<String, Object>();
        map5528.put("key5528", b5528.toString());
        String c5528 = (String) map5528.get("key5528");
        String d5528 = c5528.substring(0, c5528.length() - 1);
        String e5528 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d5528.getBytes())));
        String f5528 = e5528.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g5528 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g5528);
        ...
        response.getWriter()
                .println("sample Test java.security.SecureRandom.nextInt() executed");
    }
}