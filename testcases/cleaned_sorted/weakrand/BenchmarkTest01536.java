...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a79311 = param;
            StringBuilder b79311 = new StringBuilder(a79311);
            b79311.append(" SafeStuff");
            b79311.replace(
                    b79311.length() - "Chars".length(),
                    b79311.length(),
                    "Chars");
            java.util.HashMap<String, Object> map79311 = new java.util.HashMap<String, Object>();
            map79311.put("key79311", b79311.toString());
            String c79311 = (String) map79311.get("key79311");
            String d79311 = c79311.substring(0, c79311.length() - 1);
            String e79311 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d79311.getBytes())));
            String f79311 = e79311.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g79311 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g79311);
