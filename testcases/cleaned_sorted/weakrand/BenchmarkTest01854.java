...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a34242 = param;
        StringBuilder b34242 = new StringBuilder(a34242);
        b34242.append(" SafeStuff");
        b34242.replace(
                b34242.length() - "Chars".length(),
                b34242.length(),
                "Chars");
        java.util.HashMap<String, Object> map34242 = new java.util.HashMap<String, Object>();
        map34242.put("key34242", b34242.toString());
        String c34242 = (String) map34242.get("key34242");
        String d34242 = c34242.substring(0, c34242.length() - 1);
        String e34242 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d34242.getBytes())));
        String f34242 = e34242.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g34242 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g34242);
