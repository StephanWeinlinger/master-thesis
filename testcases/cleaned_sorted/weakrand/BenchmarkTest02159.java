...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a66015 = param;
        StringBuilder b66015 = new StringBuilder(a66015);
        b66015.append(" SafeStuff");
        b66015.replace(
                b66015.length() - "Chars".length(),
                b66015.length(),
                "Chars");
        java.util.HashMap<String, Object> map66015 = new java.util.HashMap<String, Object>();
        map66015.put("key66015", b66015.toString());
        String c66015 = (String) map66015.get("key66015");
        String d66015 = c66015.substring(0, c66015.length() - 1);
        String e66015 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d66015.getBytes())));
        String f66015 = e66015.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f66015);
