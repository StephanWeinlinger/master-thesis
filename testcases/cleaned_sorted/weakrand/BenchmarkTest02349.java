...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a55770 = param;
        StringBuilder b55770 = new StringBuilder(a55770);
        b55770.append(" SafeStuff");
        b55770.replace(
                b55770.length() - "Chars".length(),
                b55770.length(),
                "Chars");
        java.util.HashMap<String, Object> map55770 = new java.util.HashMap<String, Object>();
        map55770.put("key55770", b55770.toString());
        String c55770 = (String) map55770.get("key55770");
        String d55770 = c55770.substring(0, c55770.length() - 1);
        String e55770 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d55770.getBytes())));
        String f55770 = e55770.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f55770);
