...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map97880.put("keyA-97880", "a_Value");
            map97880.put("keyB-97880", param);
            map97880.put("keyC", "another_Value");
            bar = (String) map97880.get("keyB-97880");
            bar = (String) map97880.get("keyA-97880");
