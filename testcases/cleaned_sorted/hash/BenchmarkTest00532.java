...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a25409 = param;
        StringBuilder b25409 = new StringBuilder(a25409);
        b25409.append(" SafeStuff");
        b25409.replace(
                b25409.length() - "Chars".length(),
                b25409.length(),
                "Chars");
        java.util.HashMap<String, Object> map25409 = new java.util.HashMap<String, Object>();
        map25409.put("key25409", b25409.toString());
        String c25409 = (String) map25409.get("key25409");
        String d25409 = c25409.substring(0, c25409.length() - 1);
        String e25409 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d25409.getBytes())));
        String f25409 = e25409.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f25409);
