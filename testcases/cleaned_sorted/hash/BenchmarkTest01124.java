...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String algorithm = benchmarkprops.getProperty("sampleAlg1", "SHA512");
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map74702.put("keyA-74702", "a_Value");
            map74702.put("keyB-74702", param);
            map74702.put("keyC", "another_Value");
            bar = (String) map74702.get("keyB-74702");
            bar = (String) map74702.get("keyA-74702");
