...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a40743 = param;
        StringBuilder b40743 = new StringBuilder(a40743);
        b40743.append(" SafeStuff");
        b40743.replace(
                b40743.length() - "Chars".length(),
                b40743.length(),
                "Chars");
        java.util.HashMap<String, Object> map40743 = new java.util.HashMap<String, Object>();
        map40743.put("key40743", b40743.toString());
        String c40743 = (String) map40743.get("key40743");
        String d40743 = c40743.substring(0, c40743.length() - 1);
        String e40743 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d40743.getBytes())));
        String f40743 = e40743.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g40743 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g40743);
