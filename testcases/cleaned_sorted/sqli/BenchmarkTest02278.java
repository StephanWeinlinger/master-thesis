...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map96698.put("keyA-96698", "a_Value");
        map96698.put("keyB-96698", param);
        map96698.put("keyC", "another_Value");
        bar = (String) map96698.get("keyB-96698");
        bar = (String) map96698.get("keyA-96698");
