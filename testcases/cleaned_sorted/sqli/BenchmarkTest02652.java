...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a25323 = param;
        StringBuilder b25323 = new StringBuilder(a25323);
        b25323.append(" SafeStuff");
        b25323.replace(
                b25323.length() - "Chars".length(),
                b25323.length(),
                "Chars");
        java.util.HashMap<String, Object> map25323 = new java.util.HashMap<String, Object>();
        map25323.put("key25323", b25323.toString());
        String c25323 = (String) map25323.get("key25323");
        String d25323 = c25323.substring(0, c25323.length() - 1);
        String e25323 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d25323.getBytes())));
        String f25323 = e25323.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g25323 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g25323);
