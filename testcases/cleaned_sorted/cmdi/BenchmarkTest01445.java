...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map3083.put("keyA-3083", "a_Value");
            map3083.put("keyB-3083", param);
            map3083.put("keyC", "another_Value");
            bar = (String) map3083.get("keyB-3083");
            bar = (String) map3083.get("keyA-3083");
