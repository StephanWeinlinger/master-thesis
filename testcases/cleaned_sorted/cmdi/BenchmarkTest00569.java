...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a6821 = param;
        StringBuilder b6821 = new StringBuilder(a6821);
        b6821.append(" SafeStuff");
        b6821.replace(
                b6821.length() - "Chars".length(),
                b6821.length(),
                "Chars");
        java.util.HashMap<String, Object> map6821 = new java.util.HashMap<String, Object>();
        map6821.put("key6821", b6821.toString());
        String c6821 = (String) map6821.get("key6821");
        String d6821 = c6821.substring(0, c6821.length() - 1);
        String e6821 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d6821.getBytes())));
        String f6821 = e6821.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g6821 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g6821);
