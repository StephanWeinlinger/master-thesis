...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a43085 = param;
        StringBuilder b43085 = new StringBuilder(a43085);
        b43085.append(" SafeStuff");
        b43085.replace(
                b43085.length() - "Chars".length(),
                b43085.length(),
                "Chars");
        java.util.HashMap<String, Object> map43085 = new java.util.HashMap<String, Object>();
        map43085.put("key43085", b43085.toString());
        String c43085 = (String) map43085.get("key43085");
        String d43085 = c43085.substring(0, c43085.length() - 1);
        String e43085 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d43085.getBytes())));
        String f43085 = e43085.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g43085 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g43085);
