...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a60049 = param;
            StringBuilder b60049 = new StringBuilder(a60049);
            b60049.append(" SafeStuff");
            b60049.replace(
                    b60049.length() - "Chars".length(),
                    b60049.length(),
                    "Chars");
            java.util.HashMap<String, Object> map60049 = new java.util.HashMap<String, Object>();
            map60049.put("key60049", b60049.toString());
            String c60049 = (String) map60049.get("key60049");
            String d60049 = c60049.substring(0, c60049.length() - 1);
            String e60049 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d60049.getBytes())));
            String f60049 = e60049.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g60049 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g60049);
