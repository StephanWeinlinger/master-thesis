...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map30748.put("keyA-30748", "a_Value");
        map30748.put("keyB-30748", param);
        map30748.put("keyC", "another_Value");
        bar = (String) map30748.get("keyB-30748");
        bar = (String) map30748.get("keyA-30748");
