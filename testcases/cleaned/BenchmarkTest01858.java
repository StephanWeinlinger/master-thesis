...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("sample Test java.util.Random.nextLong() executed");
    }
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map95052.put("keyA-95052", "a_Value");
        map95052.put("keyB-95052", param);
        map95052.put("keyC", "another_Value");
        bar = (String) map95052.get("keyB-95052");
        bar = (String) map95052.get("keyA-95052");
