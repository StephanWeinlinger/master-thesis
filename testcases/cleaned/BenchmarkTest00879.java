...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        map11407.put("keyA-11407", "a_Value");
        map11407.put("keyB-11407", param);
        map11407.put("keyC", "another_Value");
        bar = (String) map11407.get("keyB-11407");
        bar = (String) map11407.get("keyA-11407");
