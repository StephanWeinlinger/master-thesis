...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map99153.put("keyA-99153", "a_Value");
        map99153.put("keyB-99153", param);
        map99153.put("keyC", "another_Value");
        bar = (String) map99153.get("keyB-99153");
        bar = (String) map99153.get("keyA-99153");
