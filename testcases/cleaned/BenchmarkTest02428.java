...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map52815.put("keyA-52815", "a_Value"); 
        map52815.put("keyB-52815", param); 
        map52815.put("keyC", "another_Value"); 
        bar = (String) map52815.get("keyB-52815"); 
        bar = (String) map52815.get("keyA-52815"); 
