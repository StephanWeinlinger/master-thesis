...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a97788 = param;
        StringBuilder b97788 = new StringBuilder(a97788);
        b97788.append(" SafeStuff");
        b97788.replace(
                b97788.length() - "Chars".length(),
                b97788.length(),
                "Chars");
        java.util.HashMap<String, Object> map97788 = new java.util.HashMap<String, Object>();
        map97788.put("key97788", b97788.toString());
        String c97788 = (String) map97788.get("key97788");
        String d97788 = c97788.substring(0, c97788.length() - 1);
        String e97788 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d97788.getBytes())));
        String f97788 = e97788.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f97788);
