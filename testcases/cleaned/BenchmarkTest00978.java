...
public class SampleValue extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        javax.servlet.http.Cookie userCookie =
                new javax.servlet.http.Cookie("SampleValue", "localhost");
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a60830 = param;
            StringBuilder b60830 = new StringBuilder(a60830);
            b60830.append(" SafeStuff");
            b60830.replace(
                    b60830.length() - "Chars".length(),
                    b60830.length(),
                    "Chars");
            java.util.HashMap<String, Object> map60830 = new java.util.HashMap<String, Object>();
            map60830.put("key60830", b60830.toString());
            String c60830 = (String) map60830.get("key60830");
            String d60830 = c60830.substring(0, c60830.length() - 1);
            String e60830 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d60830.getBytes())));
            String f60830 = e60830.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g60830 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g60830);
