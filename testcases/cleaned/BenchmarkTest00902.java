...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        map21609.put("keyA-21609", "a-Value");
        map21609.put("keyB-21609", param);
        map21609.put("keyC", "another-Value");
        bar = (String) map21609.get("keyB-21609");
        ...
        response.getWriter().println("sample Randomness Test java.util.Random.nextInt() executed");
    }
}