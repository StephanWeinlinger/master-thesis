...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a28453 = param;
            StringBuilder b28453 = new StringBuilder(a28453);
            b28453.append(" SafeStuff");
            b28453.replace(
                    b28453.length() - "Chars".length(),
                    b28453.length(),
                    "Chars");
            java.util.HashMap<String, Object> map28453 = new java.util.HashMap<String, Object>();
            map28453.put("key28453", b28453.toString());
            String c28453 = (String) map28453.get("key28453");
            String d28453 = c28453.substring(0, c28453.length() - 1);
            String e28453 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d28453.getBytes())));
            String f28453 = e28453.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g28453 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g28453);
