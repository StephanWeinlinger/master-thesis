...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map96401.put("keyA-96401", "a_Value");
            map96401.put("keyB-96401", param);
            map96401.put("keyC", "another_Value");
            bar = (String) map96401.get("keyB-96401");
            bar = (String) map96401.get("keyA-96401");
