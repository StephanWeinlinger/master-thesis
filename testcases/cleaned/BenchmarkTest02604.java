...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a92079 = param;
        StringBuilder b92079 = new StringBuilder(a92079);
        b92079.append(" SafeStuff");
        b92079.replace(
                b92079.length() - "Chars".length(),
                b92079.length(),
                "Chars");
        java.util.HashMap<String, Object> map92079 = new java.util.HashMap<String, Object>();
        map92079.put("key92079", b92079.toString());
        String c92079 = (String) map92079.get("key92079");
        String d92079 = c92079.substring(0, c92079.length() - 1);
        String e92079 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d92079.getBytes())));
        String f92079 = e92079.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f92079);
