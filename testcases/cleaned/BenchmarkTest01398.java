...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a37227 = param;
            StringBuilder b37227 = new StringBuilder(a37227);
            b37227.append(" SafeStuff");
            b37227.replace(
                    b37227.length() - "Chars".length(),
                    b37227.length(),
                    "Chars");
            java.util.HashMap<String, Object> map37227 = new java.util.HashMap<String, Object>();
            map37227.put("key37227", b37227.toString());
            String c37227 = (String) map37227.get("key37227");
            String d37227 = c37227.substring(0, c37227.length() - 1);
            String e37227 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d37227.getBytes())));
            String f37227 = e37227.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g37227 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g37227);
