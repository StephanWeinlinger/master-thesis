...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter()
                .println("sample Randomness Test java.security.SecureRandom.nextGaussian() executed");
    }
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map85251.put("keyA-85251", "a_Value");
        map85251.put("keyB-85251", param);
        map85251.put("keyC", "another_Value");
        bar = (String) map85251.get("keyB-85251");
        bar = (String) map85251.get("keyA-85251");
