...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a12849 = param;
        StringBuilder b12849 = new StringBuilder(a12849);
        b12849.append(" SafeStuff");
        b12849.replace(
                b12849.length() - "Chars".length(),
                b12849.length(),
                "Chars");
        java.util.HashMap<String, Object> map12849 = new java.util.HashMap<String, Object>();
        map12849.put("key12849", b12849.toString());
        String c12849 = (String) map12849.get("key12849");
        String d12849 = c12849.substring(0, c12849.length() - 1);
        String e12849 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d12849.getBytes())));
        String f12849 = e12849.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g12849 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g12849);
