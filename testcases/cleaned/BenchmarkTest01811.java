...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map31047.put("keyA-31047", "a_Value");
            map31047.put("keyB-31047", param);
            map31047.put("keyC", "another_Value");
            bar = (String) map31047.get("keyB-31047");
            bar = (String) map31047.get("keyA-31047");
