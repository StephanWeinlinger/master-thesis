...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a87246 = param;
        StringBuilder b87246 = new StringBuilder(a87246);
        b87246.append(" SafeStuff");
        b87246.replace(
                b87246.length() - "Chars".length(),
                b87246.length(),
                "Chars");
        java.util.HashMap<String, Object> map87246 = new java.util.HashMap<String, Object>();
        map87246.put("key87246", b87246.toString());
        String c87246 = (String) map87246.get("key87246");
        String d87246 = c87246.substring(0, c87246.length() - 1);
        String e87246 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d87246.getBytes())));
        String f87246 = e87246.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f87246);
