...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a43860 = param;
            StringBuilder b43860 = new StringBuilder(a43860);
            b43860.append(" SafeStuff");
            b43860.replace(
                    b43860.length() - "Chars".length(),
                    b43860.length(),
                    "Chars");
            java.util.HashMap<String, Object> map43860 = new java.util.HashMap<String, Object>();
            map43860.put("key43860", b43860.toString());
            String c43860 = (String) map43860.get("key43860");
            String d43860 = c43860.substring(0, c43860.length() - 1);
            String e43860 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d43860.getBytes())));
            String f43860 = e43860.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String bar = thing.doSomething(f43860);
