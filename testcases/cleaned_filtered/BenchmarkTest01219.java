...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map23263.put("keyA-23263", "a_Value");
            map23263.put("keyB-23263", param);
            map23263.put("keyC", "another_Value");
            bar = (String) map23263.get("keyB-23263");
            bar = (String) map23263.get("keyA-23263");
