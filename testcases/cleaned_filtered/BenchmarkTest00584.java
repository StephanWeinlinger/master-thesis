...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        map23020.put("keyA-23020", "a_Value");
        map23020.put("keyB-23020", param);
        map23020.put("keyC", "another_Value");
        bar = (String) map23020.get("keyB-23020");
        bar = (String) map23020.get("keyA-23020");
        ...
        response.getWriter()
                .println("sample Randomness Test java.security.SecureRandom.nextDouble() executed");
    }
}