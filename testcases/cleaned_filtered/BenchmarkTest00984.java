...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a50427 = param;
            StringBuilder b50427 = new StringBuilder(a50427);
            b50427.append(" SafeStuff");
            b50427.replace(
                    b50427.length() - "Chars".length(),
                    b50427.length(),
                    "Chars");
            java.util.HashMap<String, Object> map50427 = new java.util.HashMap<String, Object>();
            map50427.put("key50427", b50427.toString());
            String c50427 = (String) map50427.get("key50427");
            String d50427 = c50427.substring(0, c50427.length() - 1);
            String e50427 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d50427.getBytes())));
            String f50427 = e50427.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g50427 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g50427);
