...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a55741 = param;
        StringBuilder b55741 = new StringBuilder(a55741);
        b55741.append(" SafeStuff");
        b55741.replace(
                b55741.length() - "Chars".length(),
                b55741.length(),
                "Chars");
        java.util.HashMap<String, Object> map55741 = new java.util.HashMap<String, Object>();
        map55741.put("key55741", b55741.toString());
        String c55741 = (String) map55741.get("key55741");
        String d55741 = c55741.substring(0, c55741.length() - 1);
        String e55741 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d55741.getBytes())));
        String f55741 = e55741.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f55741);
