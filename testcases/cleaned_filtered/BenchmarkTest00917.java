...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        map5880.put("keyA-5880", "a_Value");
        map5880.put("keyB-5880", param);
        map5880.put("keyC", "another_Value");
        bar = (String) map5880.get("keyB-5880");
        bar = (String) map5880.get("keyA-5880");
