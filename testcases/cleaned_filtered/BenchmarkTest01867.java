...
public class SampleValue extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        javax.servlet.RequestDispatcher rd =
                request.getRequestDispatcher("/sample/sample.html");
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map94996.put("keyA-94996", "a_Value");
        map94996.put("keyB-94996", param);
        map94996.put("keyC", "another_Value");
        bar = (String) map94996.get("keyB-94996");
        bar = (String) map94996.get("keyA-94996");
