...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a87006 = param;
        StringBuilder b87006 = new StringBuilder(a87006);
        b87006.append(" SafeStuff");
        b87006.replace(
                b87006.length() - "Chars".length(),
                b87006.length(),
                "Chars");
        java.util.HashMap<String, Object> map87006 = new java.util.HashMap<String, Object>();
        map87006.put("key87006", b87006.toString());
        String c87006 = (String) map87006.get("key87006");
        String d87006 = c87006.substring(0, c87006.length() - 1);
        String e87006 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d87006.getBytes())));
        String f87006 = e87006.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f87006);
