...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map20521.put("keyA-20521", "a_Value");
            map20521.put("keyB-20521", param);
            map20521.put("keyC", "another_Value");
            bar = (String) map20521.get("keyB-20521");
            bar = (String) map20521.get("keyA-20521");
