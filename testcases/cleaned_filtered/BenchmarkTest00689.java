...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a98281 = param;
        StringBuilder b98281 = new StringBuilder(a98281);
        b98281.append(" SafeStuff");
        b98281.replace(
                b98281.length() - "Chars".length(),
                b98281.length(),
                "Chars");
        java.util.HashMap<String, Object> map98281 = new java.util.HashMap<String, Object>();
        map98281.put("key98281", b98281.toString());
        String c98281 = (String) map98281.get("key98281");
        String d98281 = c98281.substring(0, c98281.length() - 1);
        String e98281 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d98281.getBytes())));
        String f98281 = e98281.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g98281 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g98281);
