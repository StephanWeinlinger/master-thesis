...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a58606 = param;
            StringBuilder b58606 = new StringBuilder(a58606);
            b58606.append(" SafeStuff");
            b58606.replace(
                    b58606.length() - "Chars".length(),
                    b58606.length(),
                    "Chars");
            java.util.HashMap<String, Object> map58606 = new java.util.HashMap<String, Object>();
            map58606.put("key58606", b58606.toString());
            String c58606 = (String) map58606.get("key58606");
            String d58606 = c58606.substring(0, c58606.length() - 1);
            String e58606 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d58606.getBytes())));
            String f58606 = e58606.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String g58606 = "barbarians_at_the_gate";
            String bar = thing.doSomething(g58606);
