...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map75503.put("keyA-75503", "a_Value");
        map75503.put("keyB-75503", param);
        map75503.put("keyC", "another_Value");
        bar = (String) map75503.get("keyB-75503");
        bar = (String) map75503.get("keyA-75503");
