...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map90655.put("keyA-90655", "a_Value");
            map90655.put("keyB-90655", param);
            map90655.put("keyC", "another_Value");
            bar = (String) map90655.get("keyB-90655");
            bar = (String) map90655.get("keyA-90655");
