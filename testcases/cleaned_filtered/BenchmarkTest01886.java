...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a16884 = param;
        StringBuilder b16884 = new StringBuilder(a16884);
        b16884.append(" SafeStuff");
        b16884.replace(
                b16884.length() - "Chars".length(),
                b16884.length(),
                "Chars");
        java.util.HashMap<String, Object> map16884 = new java.util.HashMap<String, Object>();
        map16884.put("key16884", b16884.toString());
        String c16884 = (String) map16884.get("key16884");
        String d16884 = c16884.substring(0, c16884.length() - 1);
        String e16884 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d16884.getBytes())));
        String f16884 = e16884.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g16884 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g16884);
