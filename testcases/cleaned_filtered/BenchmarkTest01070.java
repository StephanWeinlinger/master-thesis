...
public class SampleValue extends HttpServlet {
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            String a85812 = param;
            StringBuilder b85812 = new StringBuilder(a85812);
            b85812.append(" SafeStuff");
            b85812.replace(
                    b85812.length() - "Chars".length(),
                    b85812.length(),
                    "Chars");
            java.util.HashMap<String, Object> map85812 = new java.util.HashMap<String, Object>();
            map85812.put("key85812", b85812.toString());
            String c85812 = (String) map85812.get("key85812");
            String d85812 = c85812.substring(0, c85812.length() - 1);
            String e85812 =
                    new String(
                            org.apache.commons.codec.binary.Base64.decodeBase64(
                                    org.apache.commons.codec.binary.Base64.encodeBase64(
                                            d85812.getBytes())));
            String f85812 = e85812.split(" ")[0];
            org.test.testlib.helpers.ThingInterface thing =
                    org.test.testlib.helpers.ThingFactory.createThing();
            String bar = thing.doSomething(f85812);
