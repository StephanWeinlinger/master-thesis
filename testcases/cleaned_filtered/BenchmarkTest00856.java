...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a98944 = param;
        StringBuilder b98944 = new StringBuilder(a98944);
        b98944.append(" SafeStuff");
        b98944.replace(
                b98944.length() - "Chars".length(),
                b98944.length(),
                "Chars");
        java.util.HashMap<String, Object> map98944 = new java.util.HashMap<String, Object>();
        map98944.put("key98944", b98944.toString());
        String c98944 = (String) map989944.get("key98944");
        String d98944 = c98944.substring(0, c98944.length() - 1);
        String e98944 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d98944.getBytes())));
        String f98944 = e98944.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f98944);
