...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a98424 = param;
        StringBuilder b98424 = new StringBuilder(a98424);
        b98424.append(" SafeStuff");
        b98424.replace(
                b98424.length() - "Chars".length(),
                b98424.length(),
                "Chars");
        java.util.HashMap<String, Object> map98424 = new java.util.HashMap<String, Object>();
        map98424.put("key98424", b98424.toString());
        String c98424 = (String) map98424.get("key98424");
        String d98424 = c98424.substring(0, c98424.length() - 1);
        String e98424 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d98424.getBytes())));
        String f98424 = e98424.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f98424);
