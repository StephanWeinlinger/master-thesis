...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.getWriter().println("sample Randomness Test java.lang.Math.random() executed");
    }
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        map12987.put("keyA-12987", "a-Value");
        map12987.put("keyB-12987", param);
        map12987.put("keyC", "another-Value");
        bar = (String) map12987.get("keyB-12987");
