...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a69185 = param;
        StringBuilder b69185 = new StringBuilder(a69185);
        b69185.append(" SafeStuff");
        b69185.replace(
                b69185.length() - "Chars".length(),
                b69185.length(),
                "Chars");
        java.util.HashMap<String, Object> map69185 = new java.util.HashMap<String, Object>();
        map69185.put("key69185", b69185.toString());
        String c69185 = (String) map69185.get("key69185");
        String d69185 = c69185.substring(0, c69185.length() - 1);
        String e69185 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d69185.getBytes())));
        String f69185 = e69185.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g69185 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g69185);
