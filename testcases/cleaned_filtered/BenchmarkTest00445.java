...
public class SampleValue extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String a98384 = param;
        StringBuilder b98384 = new StringBuilder(a98384);
        b98384.append(" SafeStuff");
        b98384.replace(
                b98384.length() - "Chars".length(),
                b98384.length(),
                "Chars");
        java.util.HashMap<String, Object> map98384 = new java.util.HashMap<String, Object>();
        map98384.put("key98384", b98384.toString());
        String c98384 = (String) map98384.get("key98384");
        String d98384 = c98384.substring(0, c98384.length() - 1);
        String e98384 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d98384.getBytes())));
        String f98384 = e98384.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String bar = thing.doSomething(f98384);
