...
public class SampleValue extends HttpServlet {
    ...
    private static String doSomething(HttpServletRequest request, String param)
        ...
        String a24492 = param;
        StringBuilder b24492 = new StringBuilder(a24492);
        b24492.append(" SafeStuff");
        b24492.replace(
                b24492.length() - "Chars".length(),
                b24492.length(),
                "Chars");
        java.util.HashMap<String, Object> map24492 = new java.util.HashMap<String, Object>();
        map24492.put("key24492", b24492.toString());
        String c24492 = (String) map24492.get("key24492");
        String d24492 = c24492.substring(0, c24492.length() - 1);
        String e24492 =
                new String(
                        org.apache.commons.codec.binary.Base64.decodeBase64(
                                org.apache.commons.codec.binary.Base64.encodeBase64(
                                        d24492.getBytes())));
        String f24492 = e24492.split(" ")[0];
        org.test.testlib.helpers.ThingInterface thing =
                org.test.testlib.helpers.ThingFactory.createThing();
        String g24492 = "barbarians_at_the_gate";
        String bar = thing.doSomething(g24492);
