...
public class SampleValue extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        javax.servlet.http.Cookie userCookie =
                new javax.servlet.http.Cookie("SampleValue", "anything");
        ...
        javax.servlet.RequestDispatcher rd =
                request.getRequestDispatcher("/sample-02/SampleValue.html");
    ...
    private class Test {
        ...
        public String doSomething(HttpServletRequest request, String param)
            ...
            map19964.put("keyA-19964", "a_Value");
            map19964.put("keyB-19964", param);
            map19964.put("keyC", "another_Value");
            bar = (String) map19964.get("keyB-19964");
            bar = (String) map19964.get("keyA-19964");
